...
const addImagesToGallery = () => {
  imageCurrentArray.map((data, index) => {
    if (index < 2) {
      ...
      const imageComponent = document.createElement("img");
      console.log("image compnent", imageComponent);
      const imageDiv = document.createElement("div");
      console.log("imgdiv", imageDiv);
      imageComponent.setAttribute("alt", "image");
...
// let loadMoreBtn = document.getElementById("imgButton");
// // const gallery = document.querySelector(".gallery-images");
// loadMoreBtn.addEventListener("click", showMoreImg);

// function showMoreImg(index) {
//   for (var i = 7; i < imageCurrentArray.length; i++) {
//     // const gallery = document.querySelector(".gallery-images");
//     if (i < imageCurrentArray.length - 1) {
//       var img1 = document.getElementById(`event-images${index + 1}`);
//       console.log(img1);
//       img1.style.backgroundImage = "url('" + data + "')";
//     } else {
